...
__device__ float Trace(LightSource* lights, Triangle *triangles, Vector *ray, int dept, int dev_triangles_len, int dev_lights_len, int dev_cameras_len, curandState *state);
